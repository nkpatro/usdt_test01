...
// Custom typography for crypto wallet
...
// Custom text styles for crypto-specific content
object CryptoTextStyles {
    ...
    // Small balance displays
    val BalanceSmall = TextStyle(
        fontFamily = FontFamily.Monospace,
        fontWeight = FontWeight.Medium,
        fontSize = 16.sp,
        lineHeight = 24.sp,
    ...
    // Small coin symbols (for cards/chips)
    val CoinSymbolSmall = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.Bold,
        fontSize = 12.sp,
        lineHeight = 16.sp,
